...
//        names.stream().map(String::toUpperCase).forEach(System.out::println);// Es la forma resumida
        ...
        System.out.println("============================================================================7- Operador Reduce 2");
        Optional<String> resultOptional = names.stream().reduce((a, b) -> {
            return a + " | " + b;
        });

        if (resultOptional.isPresent()) {
            System.out.println("Result: " + resultOptional.orElse(""));
        } else {
            System.out.println("Reduce retorna vacio.");
        }

        System.out.println("============================================================================8- Operador Collect. Recoge los elementos en uan colección");
...
//        List<String> listaName = names.stream().map((item) -> item.toUpperCase()).toList();// Apartir de java 17 se usa directo toList en vez de Collectors.toList()
        ...
        System.out.println("============================================================================9- Operador distinct.");
        names.stream().distinct().forEach(System.out::println);

        System.out.println("============================================================================10- Operador limit. Limitar los elimentos");
        System.out.println("Limitar en 3 elementos");
        names.stream().limit(3).forEach(System.out::println);

        System.out.println("============================================================================11- Operador skip. Omite un elmento específico");
        System.out.println("Saltamos 2 elementos");
        names.stream().skip(2).forEach(System.out::println);

        System.out.println("============================================================================12- Operador anyMath. Verifica si algún elemento cumple una condición");
        ...
        System.out.println("============================================================================13- Operador allMatch. Verifica si todos los elementos cumple la condición");
        resultBoolean = names.stream().allMatch((name) -> {
            return name.startsWith("N");
        });
        System.out.println("Imprimir el resultado: " + resultBoolean);

        System.out.println("============================================================================14- Operador noneMach. Verifica si ninguno cumple con la condición");
